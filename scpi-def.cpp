...
#include "scpi-def.h"
#include <Arduino.h>
// Pindefinitionen Digital-IO
#define DIG_OUT1 LED_BUILTIN

// Definition der Logiklevel
//#define HIGH 1
//#define LOW  0

// Schreibe Digitale Ausgänge
scpi_result_t SetDigitalOutput(scpi_t *context) {
    ...
    int pin;
    switch (channel) {
            case 1: pin = DIG_OUT1; break;
//        case 3: pin = DIG_PIN_3; break;
//        case 4: pin = DIG_PIN_4; break;
        default: return SCPI_RES_ERR; // Nur Kanal 3 & 4 erlaubt
    }
...
// Lese den Digitalen Ausgang zurück
scpi_result_t GetDigitalOutput(scpi_t *context) {
    int32_t channel;
    if (!SCPI_ParamInt32(context, &channel, TRUE)) {
        return SCPI_RES_ERR;
    }
...
// Lese einen digitalen Eingang:
scpi_result_t GetDigitalInput(scpi_t *context) {
    int32_t channel;
    if (!SCPI_ParamInt32(context, &channel, TRUE)) {
        return SCPI_RES_ERR;
    }
    ...
    int pin;
    switch (channel) {
//        case 1: pin = DIG_PIN_1; break;
//        case 2: pin = DIG_PIN_2; break;
        default: return SCPI_RES_ERR;
    }
...
const scpi_command_t scpi_commands[] = {
    ...
    { "DIGital:OUT", SetDigitalOutput },
    { "DIGital:OUT?", GetDigitalOutput },
    { "DIGital:IN?", GetDigitalInput },

    {"MEASure:POWer:DC?", SCPI_StubQ, 0},
